						...
						<div class="table-top">
							...
							<form action="<c:url value='/admin/AddTicket.action' />"
								...
								电影名称：<input type='text' name='descs' required="true"
									value='${sess.descs}' /><br /> <br /> 总票数：<input
									type="number" name='amount' required="true"
									value='${sess.amount}' /><br /> <br /> 剩余票数：<input
									type="number" name='balance' required="true"
									value='${sess.balance}' /><br /> <br /> 单价（元）：<input
									type="number" name='price' required="true" value='${sess.price}' /><br />
								<br /> 开始时间：<input type='date' name='startTime' required="true"
									value='${sess.startTime}' /><br /> <br /> 状态：
									<input 
									type=radio name=status value="0">
									禁售 <input type=radio
									name=status checked value="1">销售<br /> <br /> 小图标路径：<input
									type='text' name='Images' required="true"
									value='${sess.images}' /><br /> <br /> 相关描述：<input
									type='text' name='Descs2' required="true"
									value='${sess.descs2}' /><br /> <br /> 图片描述路径：<input
									type='text' name='images2' required="true"
									value='${sess.images2}' /><br /> <br /> 描述的顺序：<input
									type='text' name='sequence' required="true"
									value='${sess.sequence}' /><br /> <br /> <input
