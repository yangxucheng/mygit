...
<html>
    ...
    <div id=background>
		...
		<IMG NAME="IMG1" SRC="images/a4.PNG"  HEIGHT="70">
		</div>
		<div id=menu>
		<ul>
		<li><a style="color:white"; href="<c:url value='/SelectTicket2.action'/>">在线订票 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;丨</a></li>
        </ul>
		<ul>
                <li class="navmenu"><a style="color:white";>修改个人信息</a>
          <ul>
               <li><a href="<c:url value='/user/revise.jsp'/>" style="color:white";>基本信息修改</a>           
               </li> 
               <li>
               <a href="<c:url value='/user/verifyLogin.jsp'/>"; style="color:white";>个人密码修改</a>
               </li>      
         </ul>
         </li>
         </ul>
         ...
         <ul>
         <li><a style="color:white";>订单&购物车</a>
         <ul>
         <li>

   <a href="<c:url value='/user/gotoshoppingcart.action'/>" style="color:white";>购物车&结账</a>           
               </li> 
               <li>
   <a href="<c:url value='/user/pageselect.action'/>" style="color:white";>去我的订单</a>
               </li>
         ...
         <ul>
         <li><a href="<c:url value='/user/recharge.jsp'/>"; style="color:white";>&nbsp;&nbsp;账户&nbsp;&nbsp;充值</a>
         </li>
         </ul>
         
         <ul>
         <li><a href="<c:url value='/layout.action'/>"; style="color:white";>&nbsp;&nbsp;退出账号</a>
         </li>
         </ul>
         
         <ul>
         <li><a style="color:white;margin-left:440px;background-color:white;"></a>
         </li>
         </ul>
         
         <ul>
		<li><a style="color:white;margin-left:20px;width:40px;" href="<c:url value='/admin/adminlogin.jsp'/>">管理员 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
        </ul>
        ...
        <div class="slideShow" style="margin-top:40px;'">
            <!--图片布局开始-->
            <ul>
                <li><a href="ShowTicketDetail.action?tid=6" target="_bank"><img style="width:100%;height:800px"src="images/111.jpg"  /></a></li>
                <li><a href="ShowTicketDetail.action?tid=4" target="_bank"><img src="images/77.jpg"    /></a></li>
                <li><a href="ShowTicketDetail.action?tid=3" target="_bank"><img src="images/88.jpg"  /></a></li>
                <li><a href="ShowTicketDetail.action?tid=5" target="_bank"><img src="images/99.jpg"  /></a></li>
        ...
        <div id=menu2>
        <ul>
         <li><p><a href="#" ><img style="margin-top:8px;" alt="" src="images/b1.PNG"></a>
         </li>
         <li style="margin-top:8px;">打造您的专属影院</li>
         </ul>
         
         <ul>
         <li><a href="#" ><img style="margin-top:8px;" alt="" src="images/b2.PNG"></a>
         </li>
         <li style="margin-top:8px;">我的电影人生</li>
         </ul>
         
          <ul>
         <li><a href="<c:url value='/user/login.jsp'/>" ><img style="margin-top:8px;" alt="" src="images/b3.PNG"></a>
         </li>
         <li style="margin-top:8px;">登录&注册</li>
         </ul>
         
         <ul>
         <li><a href="#" ><img style="margin-top:8px;" alt="" src="images/b4.PNG"></a>
         </li>
         <li style="margin-top:8px;">附近影院</li>
         </ul>
         

         <a><img style="padding-top:20px;" alt="" src="images/b5.PNG"></a>
    ...
    <ul > 
       ...
       <center>
        <li>
        <a href="ShowTicketDetail.action?tid=6" ><img style="padding-top:20px;height:200px;width:180px;" alt="" src="images/b6.jpg"></a>
          <h1 >霸王别姬</h1>
       ...
       <center>
        <li>
        <a href="ShowTicketDetail.action?tid=7" ><img style="padding-top:20px;height:200px;width:180px;" alt="" src="images/b10.jpg"></a>
          <h1>重庆森林</h1>
       ...
       <center>
        <li>
        <a href="ShowTicketDetail.action?tid=8" ><img style="padding-top:20px;height:200px;width:180px;" alt="" src="images/b8.jpg"></a>
          <h1>大话西游</h1>
       ...
       <center>
        <li>
        <a href="ShowTicketDetail.action?tid=4" ><img style="padding-top:20px;height:200px;width:180px;" alt="" src="images/4.jpg"></a>
          <h1>魔兽</h1>
        </li>
        </div>
        ...
        <center>
        <li >
        <a href="ShowTicketDetail.action?tid=9" ><img style="padding-top:20px;height:200px;width:180px;" alt="" src="images/b11.jpg">
          <h1>情书</h1>
  ...
  <div >
   <a><img style="padding-top:300px;padding-left:200px;" alt="" src="images/b5.PNG"></a>
  </div>
