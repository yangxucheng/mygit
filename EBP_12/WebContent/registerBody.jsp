...
<div class="admin_login_wrap">
  ...
  <div class="adming_login_border">
    <div class="admin_input">
      <form action="register.php" method="post" onSubmit="return chkuserinput(this)">
 	 ...
 	 <li>
           ...
           <li>
            ...
            <input type="radio" name="sex" value="" id="sex" size="40" class="admin_input_style" />男
	    <input type="radio" name="sex" value="" id="sex" size="40" class="admin_input_style" />女
          </li>
           <li>
	...
	<p style="margin-left: 200px"><a href="index1.jsp">登录</a></p>
        </ul>
      </form>
    </div>
  </div>
